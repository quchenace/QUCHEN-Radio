 ...
 * @returns {boolean} 当前账号登录后是否自动启动 QuchenRadio。
 */
...
function refreshTrayMenu() {
  ...
  tray.setContextMenu(Menu.buildFromTemplate([
    ...
    { type: 'separator' },
    { label: '显示 QuchenRadio', click: focusMainWindow },
...
function ensureDesktopShortcut() {
  ...
  try {
    ...
    const shortcut = {
      ...
      args: '',
      description: 'QuchenRadio desktop music player',
...
function createDesktopLyricsWindow(payload = {}) {
  ...
  desktopLyricsWindow = new BrowserWindow({
    ...
    skipTaskbar: true,
    show: false,
    title: 'QuchenRadio Desktop Lyrics',
    webPreferences: {
