...
const MR_SOURCE_DIR = path.join(APPDATA_DIR || LOCALAPPDATA_DIR || process.cwd(), 'QuchenRadio', 'sources');
...
function lxRequest(url, options, callback, redirectCount = 0) {
  ...
  const headers = Object.assign({
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 QuchenRadio/LXSource',
  }, options.headers || {});
