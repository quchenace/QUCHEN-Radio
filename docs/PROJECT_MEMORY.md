...
- Implementation: the full setup reads existing HKCU/HKLM Quchen Radio install locations and may adopt them in place only when the registered path is already a dedicated `...\Quchen Radio` directory and contains Quchen Radio files or `.quchen-install-root`; it removes only the legacy `Uninstall Quchen Radio.exe` single file before writing the new safe uninstaller.
- Same-version v1.1.1 rebuild rule: an existing dedicated `...\Quchen Radio` folder that already contains Quchen Radio files may be overwritten even if it lacks `.quchen-install-root`; mixed folders such as `D:\百度盘\翻身(1)` must not be adopted in place.
...
- 可运行程序：`E:\桌面\播放器软件\Quchen-Radio\Quchen Radio.exe`
- 运行版主目录：`E:\桌面\播放器软件\Quchen Radio`
- 真实代码/Git 仓库：`E:\桌面\播放器软件\Quchen-Radio\resources\app`
- GitHub 仓库：`https://github.com/quchenace/QUCHEN-Radio.git`
...
- `v1.1.0` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.1.0`
- 仓库已设为公开：`https://github.com/quchenace/QUCHEN-Radio`
- `v1.1.0` Release 资产包括：
...
- `v1.0.10` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.10`
...
- `v1.0.9` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.9`
- `v1.0.9` Release 资产包括：
  - `latest.yml`
...
- `v1.0.8` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.8`
- `v1.0.8` Release 资产包括：
  - `latest.yml`
...
- `v1.0.7` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.7`
- `v1.0.7` Release 资产包括：
  - `latest.yml`
...
- `v1.0.6` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.6`
- `v1.0.6` Release 资产包括：
  - `latest.yml`
...
- `v1.0.5` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.5`
- `v1.0.5` Release 资产包括：
  - `latest.yml`
...
- `v1.0.4` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.4`
- `v1.0.4` Release 资产包括：
  - `latest.yml`
...
- `v1.0.3` 已发布到 GitHub：`https://github.com/quchenace/QUCHEN-Radio/releases/tag/v1.0.3`
- `v1.0.3` Release 资产包括：
  - `latest.yml`
...
- 关键参数/实现：安装路径强制规范化到独立 `Quchen Radio` 子目录；非空且非 Quchen Radio-owned 的目录阻止安装；只有 `.quchen-install-root` 标记才算 Quchen Radio-owned；新安装器跳过没有该标记的旧卸载器，只删除旧 `Uninstall Quchen Radio.exe` 单文件并清理卸载注册表；新卸载器只删除已知 Quchen Radio/Electron 顶层文件，`resources`/`locales` 等子目录只做非递归空目录删除。
...
- 关键参数/实现：`fxDefaults` 与 `PACKAGED_DEFAULT_FX_SNAPSHOT` 同步为「默认测试」；没有本地 `quchen-lyric-layout-v1` 时 `readSavedLyricLayout()` 使用 packaged snapshot；没有本地用户存档 key 时自动创建「默认测试」存档槽位。
...
- 关键参数/实现：`#quchen-control-glass-filter`、`generateControlGlassDisplacementMap()`、`--saved-panel-glass-*`、`--saved-button-glass-*`。
...
- 涉及文件：根目录 `AGENTS.md`、项目 `AGENTS.md`、本文件、用户技能 `quchen-project-memory`。
...
- 用户认可/要求保留：用户实际检查软件靠 `win-unpacked` 里的 `Quchen Radio.exe`，所以 `win-unpacked` 已提升为 `E:\桌面\播放器软件\Quchen Radio` 主目录。
- 涉及文件：`E:\桌面\播放器软件\AGENTS.md`、`E:\桌面\播放器软件\Quchen-Radio\AGENTS.md`、`AGENTS.md`、本文件。
- 关键参数/实现：真实代码/Git 仓库移动到 `E:\桌面\播放器软件\Quchen-Radio\resources\app`；可运行程序在 `E:\桌面\播放器软件\Quchen-Radio\Quchen Radio.exe`。
